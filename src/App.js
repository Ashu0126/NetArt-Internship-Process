...
function App() {
  return (
    <div className="NetArtApp">
      <img className="logo" src="/imgs/logo.png" alt="logo" />
      <div className="main">
        <img className="trophy" src="/imgs/1.png" alt="trophy" />
        <div className="mainContent">
          ...
          <img src="/imgs/2.png" alt="main-img" />
          <p className="caption">
      ...
      <div className="product">
        ...
        <div className="productSection">
          <img src="/imgs/3.png" alt="products" />
          <p>
      ...
      <footer>
        ...
        <div className="contact">
          <a href="tel:18002001234">
            <img src="/imgs/call.png" alt="call" />
            <span>
